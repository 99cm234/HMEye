namespace HMEye.TwincatServices
{
	...
	/// </summary>
	public interface IPlcEventCacheService : IDisposable, IHostedService
	{
		/// <summary>
		...
		IReadOnlyCollection<EventLoggerEvent> GetCachedEvents();
		...
		IReadOnlyCollection<EventLoggerEvent> GetCachedActiveAlarms();
