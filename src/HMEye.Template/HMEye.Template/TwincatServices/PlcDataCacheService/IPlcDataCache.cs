namespace HMEye.TwincatServices
{
	...
	/// </summary>
	public interface IPlcDataCache : IHostedService, IDisposable
	{
		/// <summary>
		...
		/// <typeparam name="T">The type of the value to read.</typeparam>
		/// <param name="address">The address of the variable to read.</param>
		/// <returns>A <see cref="ReadResult{T}"/> containing the cached value or error information.</returns>
		ReadResult<T> TryReadCached<T>(string address);
		...
		/// <typeparam name="T">The type of the value to read.</typeparam>
		/// <param name="address">The address of the variable to read.</param>
		/// <returns>A task that returns a <see cref="ReadResult{T}"/> containing the value or error information.</returns>
		Task<ReadResult<T>> TryReadImmediateAsync<T>(string address);
		...
		/// <param name="address">The address of the variable to write.</param>
		/// <param name="value">The value to write.</param>
		/// <returns>A task that returns a <see cref="WriteResult"/> indicating the success or failure of the operation.</returns>
		Task<WriteResult> TryWriteImmediateAsync<T>(string address, T value)
			where T : notnull;
		...
		/// <param name="address">The address of the variable to write.</param>
		/// <param name="value">The value to write.</param>
		/// <returns>A <see cref="WriteResult"/> indicating the success or failure of queuing the operation.</returns>
		WriteResult TryWriteQueue<T>(string address, T value)
			where T : notnull;
		...
		void AddCacheItem(CacheItemConfig config);
