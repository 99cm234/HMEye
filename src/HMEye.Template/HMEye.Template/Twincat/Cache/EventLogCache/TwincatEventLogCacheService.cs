...
namespace HMEye.TwincatServices.Cache.EventLogCache
{
	...
	/// </summary>
	public class TwincatEventLogCacheService : ITwincatEventLogCacheService, IHostedService
	{
		private readonly ITwincatEventLogService _eventLogger;
		private readonly ILogger<TwincatEventLogCacheService> _logger;
		private readonly TwincatEventLogCacheSettings _settings;
		...
		public TwincatEventLogCacheService(
			ITwincatEventLogService eventLogger,
			ILogger<TwincatEventLogCacheService> logger,
			IOptions<TwincatEventLogCacheSettings> options)
		{
