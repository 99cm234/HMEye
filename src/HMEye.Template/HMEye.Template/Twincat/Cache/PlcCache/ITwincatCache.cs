namespace HMEye.TwincatServices.Cache.PlcCache
{
	...
	/// </summary>
		public interface ITwincatCache : IHostedService, IDisposable
	{
		/// <summary>
		...
		/// <typeparam name="T">The type of the value to read.</typeparam>
		/// <param name="address">The address of the variable to read.</param>
		/// <returns>A <see cref="TwincatCacheReadResult{T}"/> containing the cached value or error information.</returns>
		TwincatCacheReadResult<T> TryReadCached<T>(string address);
		...
		/// <typeparam name="T">The type of the value to read.</typeparam>
		/// <param name="address">The address of the variable to read.</param>
		/// <returns>A task that returns a <see cref="TwincatCacheReadResult{T}"/> containing the value or error information.</returns>
		Task<TwincatCacheReadResult<T>> TryReadImmediateAsync<T>(string address);
		...
		/// <param name="address">The address of the variable to write.</param>
		/// <param name="value">The value to write.</param>
		/// <returns>A task that returns a <see cref="TwincatCacheWriteResult"/> indicating the success or failure of the operation.</returns>
		Task<TwincatCacheWriteResult> TryWriteImmediateAsync<T>(string address, T value)
			where T : notnull;
		...
		/// <param name="address">The address of the variable to write.</param>
		/// <param name="value">The value to write.</param>
		/// <returns>A <see cref="TwincatCacheWriteResult"/> indicating the success or failure of queuing the operation.</returns>
		TwincatCacheWriteResult TryWriteQueue<T>(string address, T value)
			where T : notnull;
		...
		void AddCacheItem(TwincatCacheItemConfig config);
