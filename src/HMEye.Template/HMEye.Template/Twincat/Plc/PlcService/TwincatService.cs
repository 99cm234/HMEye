...
{
		public class TwincatService : IDisposable, IHostedService, ITwincatService
	{
		...
		public TwincatService(ILogger<TwincatService> logger, IOptions<TwincatSettings> options)
		{
		...
		public Task StartAsync(CancellationToken cancellationToken = default)
		{
			...
			{
				_logger.LogError(ex, "Failed to start TwincatService");
				throw;
			}
		}
