...
namespace HMEye.TwincatServices.Plc.PlcService
{
	/// <summary>
	...
	/// </summary>
	/// <remarks>
	/// Service should be registered in Program.cs as a singleton and hosted service using the ITwincatService interface:
	/// <code>
	/// builder.Services.AddSingleton<ITwincatService, TwincatService>();
	/// builder.Services.AddHostedService<ITwincatService>(sp => sp.GetRequiredService<ITwincatService>());
	/// </code>
	/// </remarks>
		public interface ITwincatService : IDisposable, IHostedService
	{
		/// <summary>
