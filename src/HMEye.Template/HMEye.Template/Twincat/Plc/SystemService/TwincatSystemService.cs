...
namespace HMEye.TwincatServices.Plc.SystemService
{
		public class TwincatSystemService : IDisposable, IHostedService, ITwincatSystemService
	{
		private readonly ILogger<TwincatSystemService> _logger;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="TwincatSystemService"/> class.
		/// </summary>
		...
		public TwincatSystemService(ILogger<TwincatSystemService> logger, IOptions<TwincatSettings> options)
		{
