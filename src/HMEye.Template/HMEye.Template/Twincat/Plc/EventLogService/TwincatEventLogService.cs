...
{
		public class TwincatEventLogService : IDisposable, IHostedService, ITwincatEventLogService
	{
		private readonly ILogger<TwincatEventLogService> _logger;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="TwincatEventLogService"/> class.
		/// </summary>
		...
		public TwincatEventLogService(ILogger<TwincatEventLogService> logger, IOptions<TwincatSettings> options)
		{
